...
public class CategoryPropertyKeyService {
    ...
    public CategoryPropertyKeyResponse createCategoryPropertyKey(Long categoryId, CategoryPropertyKeyRequest request) {
        ...
        for (CategoryPropertyValueRequest valueRequest : request.getCategoryPropertyValues()) {
        ...
        categoryPropertyKey.setCategoryPropertyValues(values);
    ...
    public ResponseMessage<CategoryPropertyKeyResponse> updateCategoryPropertyKey(Long keyId, CategoryPropertyKeyRequest keyRequest) {
        ...
        Map<Long, CategoryPropertyValue> existingValuesMap = existingKey.getCategoryPropertyValues().stream()
        ...
        for (CategoryPropertyValueRequest valueRequest : keyRequest.getCategoryPropertyValues()) {
        ...
        existingKey.getCategoryPropertyValues().clear();
        existingKey.getCategoryPropertyValues().addAll(updatedValues);
