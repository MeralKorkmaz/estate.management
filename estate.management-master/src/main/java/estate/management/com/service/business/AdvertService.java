...
public class AdvertService {
    ...
    public Advert findById(int advertId) {
        Optional <Advert>opAdvert=advertRepository.findById((long) advertId);
        if(!opAdvert.isPresent()){
           throw new IllegalStateException(ErrorMessages.ADVERT_ID_NOT_FOUND_ERROR);
